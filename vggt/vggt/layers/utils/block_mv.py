...
from ..mlp import Mlp
from .flex_atten import Attention_attenmap
...
class Block_mv(nn.Module):
    def __init__(
        ...
        attn_class: Callable[..., nn.Module] = Attention_attenmap, # modify to flex atten
    ...
    def forward(self, x: Tensor, pos=None,q_idx=None) -> Tensor:
        def attn_residual_func(x: Tensor, pos=None) -> Tensor:
            ...
            return self.ls1(self.attn(self.norm1(x), pos=pos, q_idx=q_idx))
