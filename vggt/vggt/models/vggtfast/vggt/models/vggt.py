...
from vggt.models.vggtfast.vggt.models.aggregator import Fast_Aggregator
from vggt.models.vggtfast.vggt.heads.camera_head import CameraHead
from vggt.models.vggtfast.vggt.heads.dpt_head import DPTHead
from vggt.models.vggtfast.vggt.heads.track_head import TrackHead
from vggt.utils.pose_enc import extri_intri_to_pose_encoding, pose_encoding_to_extri_intri,extri_to_pose_encoding

class Fast_VGGT(nn.Module, PyTorchModelHubMixin):
    def __init__(
        self,
        img_size=518,
        patch_size=14,
...
class Fast_VGGT_rel(nn.Module, PyTorchModelHubMixin):
    def __init__(
        self,
        img_size=518,
        patch_size=14,
