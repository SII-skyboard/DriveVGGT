...
from vggt.models.streamvggt.streamvggt.models.aggregator import Aggregator
from vggt.models.streamvggt.streamvggt.heads.camera_head import CameraHead
from vggt.models.streamvggt.streamvggt.heads.dpt_head import DPTHead
from vggt.models.streamvggt.streamvggt.heads.track_head import TrackHead
    ...
    def forward(
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            for s in range(S):
                ...
                ress.append(res)
            # return StreamVGGTOutput(ress=ress, views=images)  # [S] [B, C, H, W]
            return predictions
