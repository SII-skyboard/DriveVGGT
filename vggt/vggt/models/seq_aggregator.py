...
from vggt.models.aggregator_mv import Aggregator_mv
...
class MultiViewVGGT_v2(nn.Module, PyTorchModelHubMixin):
    def __init__(self, img_size=518, patch_size=14, embed_dim=1024,
        ...
        self.aggregator = Aggregator_mv(img_size=img_size, patch_size=patch_size, embed_dim=embed_dim,view_num=len(self.cam_list))
